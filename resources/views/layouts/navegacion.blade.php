<nav class="navbar navbar-expand-lg navbar-light orange">
  ...
  <a class="navbar-brand logo" href="{{ action( 'ControladorRutas@inicio' ) }}">HotelPocasPulgas</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link negrita animacion-item-nav" href="{{ action( 'ControladorRutas@inicio' ) }}">Inicio<span class="sr-only">(current)</span></a>
      </li>
